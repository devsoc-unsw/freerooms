    ...
    <div id={"LandingScreenWhole"} style={{
      ...
      <div style={{ width: "auto", display: "flex", flexDirection: "column", margin: "auto" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
          <a className={"button-gradient"} style={{ gap: "1rem", width: "4rem" }} href={"/browse"} id={"FreeroomsCTA"}>
          ...
          <a className={"button-gradient"} style={{ gap: "1rem", width: "4rem" }} href={"/map"} id={"FreeroomsCTA"}>
